...
library.theme = {
    ...
    accentcolor2 = Color3.fromRGB(102,0,255),
...
function library:CreateWatermark(name, position)
    ...
    watermark.text = "".. name:gsub("{game}", gamename):gsub("{fps}", fps .. " FPS") .. " ┃ "..month..dd4..day..th.." "..year
    ...
    watermark.mainbar.Position = UDim2.new(0, 100, 0, 38/2-10)
    ...
    runservice.Heartbeat:Connect(function()
        ...
        if name:find("{fps}") then
            ...
            if currentTime - startTime >= 1 then 
                ...
                if fps ~= oldfps then
                    watermark.label.Text = " " .. name:gsub("{game}", gamename):gsub("{fps}", fps .. " FPS") .. "┃ "..month..dd4..day..th.." "..year 
